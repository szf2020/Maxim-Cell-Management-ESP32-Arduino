...
//balance
#define CBMODE_MANUAL_MINUTE (0x3 << 11)
#define CBDUTY_93_PERCENT (0xe << 4)
#define CBTEMP_EN (1 << 2) // shutdown if die hot
#define CBMEASEN_OFF 1 // Embedded ADC/CAL Measurements and CBUVTHR Checking Disabled
