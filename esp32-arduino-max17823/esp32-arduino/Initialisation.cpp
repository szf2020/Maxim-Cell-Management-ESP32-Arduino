...
void Initialisation::enable_measurement(char slave_cells, char modules) {
  ...
  PEC_VALUE = pec.pec_code(4, WRITEALL, ADDR_MEASUREEN, lowByte(reg_val), highByte(reg_val));  // PEC calculation for BITS WRITEALL, ADDR_MEASUREEN1, 0xFF, 0xFF
  bms_SPI.SPI_commands(8, WR_LD_Q0, 0x06, WRITEALL, ADDR_MEASUREEN, lowByte(reg_val), highByte(reg_val), PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);  // Write Next queue
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);  // Checks the calculated and hardware returned PEC

  PEC_VALUE = pec.pec_code(3, READALL, ADDR_MEASUREEN, DATA_CHECK);  // PEC calculation for BITS READALL,ADDR_MEASUREEN,DATA_CHECK
  bms_SPI.SPI_commands(7, WR_LD_Q0, 0x06, READALL, ADDR_MEASUREEN, DATA_CHECK, PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);         // Checks the calculated and hardware returned PEC
  bms_SPI.SPI_commands(2, READ_RX_INTERRUPT_FLAGS, NULL_XX);  // Read RX_interrupt flags
  ...
  reg_val = slave_cells & 0xf;

  PEC_VALUE = pec.pec_code(4, WRITEALL, ADDR_TOPCELL, lowByte(reg_val), highByte(reg_val));  // PEC calculation for BITS WRITEALL, ADDR_MEASUREEN1, 0xFF, 0xFF
  bms_SPI.SPI_commands(8, WR_LD_Q0, 0x06, WRITEALL, ADDR_TOPCELL, lowByte(reg_val), highByte(reg_val), PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);  // Write Next queue
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);  // Checks the calculated and hardware returned PEC

  PEC_VALUE = pec.pec_code(3, READALL, ADDR_TOPCELL, DATA_CHECK);  // PEC calculation for BITS READALL,ADDR_MEASUREEN,DATA_CHECK
  bms_SPI.SPI_commands(7, WR_LD_Q0, 0x06, READALL, ADDR_TOPCELL, DATA_CHECK, PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);         // Checks the calculated and hardware returned PEC
  bms_SPI.SPI_commands(2, READ_RX_INTERRUPT_FLAGS, NULL_XX);  // Read RX_interrupt flags
  ...
  PEC_VALUE = pec.pec_code(4, WRITEALL, ADDR_DIAGCFG, lowByte(reg_val), highByte(reg_val));  // PEC calculation for BITS WRITEALL, ADDR_MEASUREEN1, 0xFF, 0xFF
  bms_SPI.SPI_commands(8, WR_LD_Q0, 0x06, WRITEALL, ADDR_DIAGCFG, lowByte(reg_val), highByte(reg_val), PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);  // Write Next queue
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);  // Checks the calculated and hardware returned PEC

  PEC_VALUE = pec.pec_code(3, READALL, ADDR_DIAGCFG, DATA_CHECK);  // PEC calculation for BITS READALL,ADDR_MEASUREEN,DATA_CHECK
  bms_SPI.SPI_commands(7, WR_LD_Q0, 0x06, READALL, ADDR_DIAGCFG, DATA_CHECK, PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);         // Checks the calculated and hardware returned PEC
  bms_SPI.SPI_commands(2, READ_RX_INTERRUPT_FLAGS, NULL_XX);  // Read RX_interrupt flags
  ...
  PEC_VALUE = pec.pec_code(4, WRITEALL, ADDR_WATCHDOG, lowByte(reg_val), highByte(reg_val));  // PEC calculation for BITS WRITEALL, ADDR_MEASUREEN1, 0xFF, 0xFF
  bms_SPI.SPI_commands(8, WR_LD_Q0, 0x06, WRITEALL, ADDR_WATCHDOG, lowByte(reg_val), highByte(reg_val), PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);  // Write Next queue
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);  // Checks the calculated and hardware returned PEC

  PEC_VALUE = pec.pec_code(3, READALL, ADDR_WATCHDOG, DATA_CHECK);  // PEC calculation for BITS READALL,ADDR_MEASUREEN,DATA_CHECK
  bms_SPI.SPI_commands(7, WR_LD_Q0, 0x06, READALL, ADDR_WATCHDOG, DATA_CHECK, PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);         // Checks the calculated and hardware returned PEC
  bms_SPI.SPI_commands(2, READ_RX_INTERRUPT_FLAGS, NULL_XX);  // Read RX_interrupt flags
  ...
  PEC_VALUE = pec.pec_code(4, WRITEALL, ADDR_ACQCFG, lowByte(reg_val), highByte(reg_val));  // PEC calculation for BITS WRITEALL, ADDR_MEASUREEN1, 0xFF, 0xFF
  bms_SPI.SPI_commands(8, WR_LD_Q0, 0x06, WRITEALL, ADDR_ACQCFG, lowByte(reg_val), highByte(reg_val), PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);  // Write Next queue
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);  // Checks the calculated and hardware returned PEC

  PEC_VALUE = pec.pec_code(3, READALL, ADDR_ACQCFG, DATA_CHECK);  // PEC calculation for BITS READALL,ADDR_MEASUREEN,DATA_CHECK
  bms_SPI.SPI_commands(7, WR_LD_Q0, 0x06, READALL, ADDR_ACQCFG, DATA_CHECK, PEC_VALUE, ALIVE_COUNTER);
  bms_SPI.SPI_commands(1, WR_NXT_LD_Q0);
  SPI_return = bms_SPI.SPI_commands(8, RD_NXT_MSG, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX, NULL_XX);
  PEC_check_status = pec.PEC_Check(1, 5, SPI_return);         // Checks the calculated and hardware returned PEC
  bms_SPI.SPI_commands(2, READ_RX_INTERRUPT_FLAGS, NULL_XX);  // Read RX_interrupt flags
